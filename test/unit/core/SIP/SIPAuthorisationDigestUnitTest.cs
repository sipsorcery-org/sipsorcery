...
opaque=""FQhe/qaU925kfnzjCev0ciny7QMkPqMAFRtzCUYo5tdS""");
        ...
        /// <summary>
        /// Guards the span based ParseAuthorisationDigest rewrite. A base64 nonce that ends with '='
        /// padding must be preserved verbatim. The header is split on the first '=' only, so the
        /// padding characters in the value must not be lost or treated as additional separators.
        /// </summary>
        [Fact]
        ...
        /// recognised (exercises the explicit StringComparison handling in the rewrite).
        /// </summary>
        [Fact]
