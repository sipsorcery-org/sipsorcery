...
namespace SIPSorcery.Entities
{
    ...
    public sealed partial class SimpleWizardDialPlanRule : Entity
    {
        ...
        partial void OnCommandStringChanging(string value);
        ...
        /// <summary>
        /// Gets or sets the 'CommandString' value.
        /// </summary>
        [DataMember()]
        [Required()]
        public string CommandString
        {
            ...
            set
            {
                ...
                {
                    this.OnCommandStringChanging(value);
                    this.RaiseDataMemberChanging("CommandString");
                    this.ValidateProperty("CommandString", value);
                    this._commandString = value;
                    this.RaiseDataMemberChanged("CommandString");
                    this.OnCommandStringChanged();
                }
            }
        }
    ...
    public sealed partial class SIPAccount : Entity
    {
        ...
        /// </summary>
        [Association("SIPAccount_SimpleWizardDialPlanRule", "ID", "ToSIPAccount")]
        [XmlIgnore()]
        public EntityCollection<SimpleWizardDialPlanRule> simplewizarddialplanrules
        {
            get
            {
                ...
                {
                    this._simplewizarddialplanrules = new EntityCollection<SimpleWizardDialPlanRule>(this, "simplewizarddialplanrules", this.Filtersimplewizarddialplanrules);
                }
        ...
        {
            return (entity.ToSIPAccount == this.ID);
        }
