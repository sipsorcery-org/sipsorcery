...
* [WebRTCReceiver](https://github.com/sipsorcery/sipsorcery/tree/master/examples/WebRTCReceiver): A receive only example. It attmepts to connect to a WebRTC peer and display the video stream that it recives.
