| Target        | SIPSorcery    | Examples (Windows Only)    | Softphone (Windows Only) |
| --------------| ------------- |:-------------|:--------- |
