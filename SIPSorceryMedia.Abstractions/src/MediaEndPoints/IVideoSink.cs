...
public interface IVideoSink
{
    ...
    /// </summary>
    event Action<byte[], uint, uint, int, VideoPixelFormatsEnum> OnVideoSinkDecodedSample;

    event Action<RawImage> OnVideoSinkDecodedSampleFaster; // Avoid to use byte[] to improve performance
