...
//
// Ported verbatim from the WebRTCMaxHeadroom example to back the CLI "bridge ...
// agent --avatar" face; nullable is disabled so the example code compiles unchanged
// in the (nullable-enabled) CLI project.
//
// License:
