...
{
    /// <summary>
    /// The fixed event type string: "response.output_audio.done".
    /// Renamed in the GA Realtime API from the beta "response.audio.done".
    /// </summary>
    public const string TypeName = "response.output_audio.done";
