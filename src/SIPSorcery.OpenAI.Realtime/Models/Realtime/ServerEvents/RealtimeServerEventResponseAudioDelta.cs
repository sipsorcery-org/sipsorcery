...
{
    /// <summary>
    /// The fixed event type string: "response.output_audio.delta".
    /// Renamed in the GA Realtime API from the beta "response.audio.delta".
    /// </summary>
    public const string TypeName = "response.output_audio.delta";
