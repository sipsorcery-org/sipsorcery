...
namespace SIPSorcery.SIP.App
{
    ...
    public class SIPB2BUserAgent : SIPServerUserAgent, ISIPClientUserAgent
    {
        ...
        {
            logger.LogB2BUserAgentServerCallCancelled(sipCancelRequest?.Header.Reason);
            m_uac?.Cancel();
        }
        ...
        {
            logger.LogSIPB2BUserAgentCallCancelled();
            m_uac.Cancel(reason);
        ...
        {
            logger.LogClientCallFailed(resp.ShortDescription);
