    ...
    public class SIPRequestAuthenticator
    {
            ...
            ISIPAccount sipAccount)
        {
            try
            {
                ...
                {
                    logger.LogSipAccountDisabled(sipAccount.SIPUsername, sipAccount.SIPDomain, sipRequest.Method);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            logger.LogAuthenticationStaleNonce(sipAccount.SIPDomain, sipAccount.SIPUsername, uri, requestNonce, sipRequest.Method);
                        ...
                        else
                        {
                            ...
                            {
                                logger.LogAuthenticationTokenCheckFailed(sipAccount.SIPDomain, sipAccount.SIPUsername, uri, requestNonce, sipRequest.Method);
            ...
            {
                logger.LogAuthoriseSipRequestError(excp.Message, excp);
