...
//    protected static ILogger logger = LogFactory.CreateLogger<SocketConnection>();
...
//    /// </summary>
//    public event Action<UdpReceiver, int, IPEndPoint?, ReadOnlyMemory<byte>>? OnPacketReceived;
