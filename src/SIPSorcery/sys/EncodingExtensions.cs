...
internal static class EncodingExtensions
{
    extension(global::System.Text.Encoding encoding)
    {
        ...
        /// <returns>
        /// <c> true</c> if the encoded bytes of <paramref name="str"/> exactly match <paramref name="bytes"/>;
        /// otherwise, <c> false</c>.
        /// </returns>
        ...
        public string GetString(ReadOnlyMemory<byte> bytes) => encoding.GetString(bytes.Span);
    }
}
