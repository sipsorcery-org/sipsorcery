...
internal static partial class MediaLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "SettingAudioFormatAndClockRate",
        Level = LogLevel.Debug,
        Message = "Setting audio source format to {FormatID}:{Codec} {ClockRate} (RTP clock rate {RtpClockRate}).")]
    public static partial void LogSettingAudioFormatAndClockRate(
        this ILogger logger,
        int formatID,
    ...
    // VoIPMediaSession:204 and EchoMediaSession:56 - audio source format with detailed params
    [LoggerMessage(
        EventId = 0,
        EventName = "SettingAudioSourceFormatAndClockRate",
        Level = LogLevel.Debug,
        Message = "Setting audio source format to {FormatID}:{Codec} {ClockRate} (RTP clock rate {RtpClockRate}).")]
    public static partial void LogSettingAudioSourceFormatAndClockRate(
        this ILogger logger,
        int formatID,
        AudioCodecsEnum codec,
        int clockRate,
    ...
    // VoIPMediaSession:222 and EchoMediaSession:81 - video sink/source format with string codec
    [LoggerMessage(
        EventId = 0,
        EventName = "SettingVideoSinkAndSourceFormat",
        Level = LogLevel.Debug,
        Message = "Setting video sink and source format to {VideoFormatID}:{VideoCodec}.")]
    public static partial void LogSettingVideoSinkAndSourceFormat(
        this ILogger logger,
        int videoFormatID,
        VideoCodecsEnum videoCodec);

    // AudioSendOnlyMediaSession:40 - audio format with string codec
    [LoggerMessage(
        EventId = 0,
        EventName = "SettingAudioFormat",
        Level = LogLevel.Debug,
        Message = "Setting audio source format to {AudioFormatID}:{AudioCodec}.")]
    public static partial void LogSettingAudioFormat(
        this ILogger logger,
        int audioFormatID,
        AudioCodecsEnum audioCodec);

    // VoIPMediaSession:230 and EchoMediaSession:96 - text format with string codec
    [LoggerMessage(
        EventId = 0,
        EventName = "SettingTextSinkAndSourceFormat",
        Level = LogLevel.Debug,
        Message = "Setting text sink and source format to {TextFormatID}:{TextCodec}.")]
    public static partial void LogSettingTextSinkAndSourceFormat(
        this ILogger logger,
        int textFormatID,
        TextCodecsEnum textCodec);

    // EchoMediaSession:88 - video echo not implemented warning
    [LoggerMessage(
        EventId = 0,
        EventName = "VideoEchoNotImplemented",
        Level = LogLevel.Warning,
        Message = "Video frame received, echoing not yet implemented.")]
    public static partial void LogVideoEchoNotImplemented(this ILogger logger);

    // EchoMediaSession:119 - starting audio format
    [LoggerMessage(
        EventId = 0,
        EventName = "StartingAudioFormat",
        Level = LogLevel.Debug,
        Message = "{Session} starting audio with format {AudioFormatID}:{AudioCodec}.")]
    public static partial void LogStartingAudioFormat(
        this ILogger logger,
        string session,
        int audioFormatID,
        AudioCodecsEnum audioCodec);
