...
internal static partial class SipAppLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "ExceptionServerResponseReceived",
        Level = LogLevel.Error,
        Message = "Exception SIPRegistrationUserAgent ServerResponseReceived ({RemoteEndPoint}). {ErrorMessage}")]
    public static partial void LogExceptionServerResponseReceived(
        this ILogger logger,
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "WarningNoHA1CredentialAvailable",
        Level = LogLevel.Warning,
        Message = "No HA1 credential is available for any of the server challenges.")]
    public static partial void LogWarningNoHA1CredentialAvailable(
        this ILogger logger);

    [LoggerMessage(
        EventId = 0,
        EventName = "WarningNoPasswordProvided",
        Level = LogLevel.Warning,
        Message = "No password provided to respond to server challenges.")]
    public static partial void LogWarningNoPasswordProvided(
        this ILogger logger);
