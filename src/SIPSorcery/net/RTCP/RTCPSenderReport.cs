...
public partial class RTCPSenderReport : IByteSerializable
{
    ...
    public int WriteTo(IBufferWriter<byte> writer)
    {
        ...
        writer.WriteUInt64BigEndian(NtpTimestamp);
        writer.WriteUInt32BigEndian(RtpTimestamp);
        writer.WriteUInt32BigEndian(PacketCount);
        writer.WriteUInt32BigEndian(OctetCount);
