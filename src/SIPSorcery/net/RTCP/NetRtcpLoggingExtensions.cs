...
internal static partial class NetRtcpLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "RtcpFeedbackSerializationNotImplemented",
        Level = LogLevel.Debug,
        Message = "Serialization for feedback report {PacketType} and message type {FeedbackMessageType} not yet implemented.")]
    public static partial void LogRtcpFeedbackSerializationNotImplemented(
        this ILogger logger,
