...
internal static partial class NetRtpLoggingExtensions
{
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Warning,
        Message = "EndSendTo Send error: {SocketErrorCode}")]
    public static partial void LogRtpChannelSocketError(
        this ILogger logger,
    ...
    private static partial void LogRtpSessionRemoteSdpSsrcAttributesUnchecked(
        this ILogger logger,
        string remoteSDPSsrcAttributes);

    public static void LogRtpSessionRemoteSdpSsrcAttributes(
        this ILogger logger,
        List<List<SDPSsrcAttribute>> audioRemoteSDPSsrcAttributes,
        List<List<SDPSsrcAttribute>> videoRemoteSDPSsrcAttributes,
        List<System.Collections.Generic.List<SDPSsrcAttribute>> textRemoteSDPSsrcAttributes)
    {
        ...
        logger.LogRtpSessionRemoteSdpSsrcAttributesUnchecked(builder.ToString());
    }
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "RtpSocketExceptionSendAv1Frame",
        Level = LogLevel.Error,
        Message = "SocketException SendAv1Frame. {ErrorMessage}")]
    public static partial void LogRtpSocketExceptionSendAv1Frame(
        this ILogger logger,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "RtpSocketExceptionSendVp9Frame",
        Level = LogLevel.Error,
        Message = "SocketException SendVp9Frame. {ErrorMessage}")]
    public static partial void LogRtpSocketExceptionSendVp9Frame(
        this ILogger logger,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Warning,
        Message = "Can't create RTCPCompoundPacket from the provided RTCP bytes.")]
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Error,
        Message = "Exception RTPChannel.Send.")]
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "TurnRelaySendError",
        Level = LogLevel.Warning,
        Message = "{Caller} error sending TURN relay request to TURN server at {RelayEndPoint}. {SendResult}.")]
    public static partial void LogTurnRelaySendError(
        this ILogger logger,
        string caller,
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "RtpSessionRtcpPacketReceived",
        Level = LogLevel.Trace,
        Message = "RTCP packet received from {RemoteEndPoint} {Buffer}",
        SkipEnabledCheck = true)]
    private static partial void LogRtpSessionRtcpPacketReceivedUnchecked(
        this ILogger logger,
        IPEndPoint remoteEndPoint,
        string buffer);

    public static void LogRtpSessionRtcpPacketReceived(
        this ILogger logger,
        IPEndPoint remoteEndPoint,
        ReadOnlyMemory<byte> buffer)
    {
        ...
        {
            LogRtpSessionRtcpPacketReceivedUnchecked(logger, remoteEndPoint, buffer.Span.HexStr());
        }
    }

    [LoggerMessage(
        EventId = 0,
        EventName = "Vp9DepacketiserCouldNotParsePayloadDescriptor",
        Level = LogLevel.Warning,
        Message = "VP9 depacketiser could not parse the payload descriptor, discarding packet.")]
    public static partial void LogVp9DepacketiserCouldNotParsePayloadDescriptor(
        this ILogger logger);

    [LoggerMessage(
        EventId = 0,
        EventName = "RtpSocketExceptionSendVp9FrameError",
        Level = LogLevel.Error,
        Message = "SocketException SendVp9Frame.")]
    public static partial void LogRtpSocketExceptionSendVp9FrameError(
        this ILogger logger,
        Exception exception);

    [LoggerMessage(
        EventId = 0,
        EventName = "Vp9DepacketiserFailedPayloadData",
        Level = LogLevel.Warning,
        Message = "VP9 depacketiser failed to write payload data.")]
    public static partial void LogVp9DepacketiserFailedPayloadData(
        this ILogger logger,
        Exception exception);

    [LoggerMessage(
        EventId = 0,
        EventName = "MediaStreamUnknownPayloadType",
        Level = LogLevel.Warning,
        Message = "Received RTP packet with unknown payload type {PayloadType} for {MediaType} stream from {RemoteEndPoint}.")]
    public static partial void LogMediaStreamUnknownPayloadType(
        this ILogger logger,
        int payloadType,
        SDPMediaTypesEnum mediaType,
        IPEndPoint remoteEndPoint);
