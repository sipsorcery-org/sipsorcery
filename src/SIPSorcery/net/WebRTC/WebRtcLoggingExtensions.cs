...
internal static partial class WebRtcLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "WebRtcSctpPacketParseError",
        Level = LogLevel.Warning,
        Message = "SCTP error parsing packet received on RTCSctpTransport, packet dropped. {Message}")]
    public static partial void LogWebRtcSctpPacketParseError(
        this ILogger logger,
        string message,
        Exception exception);
