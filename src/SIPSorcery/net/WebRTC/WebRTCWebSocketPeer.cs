...
public class WebRTCWebSocketPeer : WebSocketBehavior
{
    ...
    protected override async void OnMessage(MessageEventArgs e)
    {
        ...
        {
            logger.LogGotRemoteIceCandidateSimple();
            ...
            else if (RTCSessionDescriptionInit.TryParse(e.Data, out var descriptionInit))
            {
                ...
                if (result != SetDescriptionResultEnum.OK)
                {
                    ...
                    logger.LogRemoteSdpWas(descriptionInit.sdp);
                ...
                else
                {
                    ...
                    logger.LogSdpAnswerToRemoteClient(Context.UserEndPoint);
        ...
        {
            logger.LogSignalingJsonParseFailedServer(e.Data);
        }
    }
    ...
    protected override async void OnOpen()
    {
        ...
        logger.LogSocketConnectionFromUserEndPoint(Context.UserEndPoint);
        ...
        if (base.Context.QueryString["role"] != "offer")
        {
            ...
            logger.LogSdpOfferToClientEndPoint(Context.UserEndPoint);
            // Don't log SDP can contain sensitive info, albeit very short lived.
            ...
            {
                logger.LogOnOpenErrorExtended(ex);
            }
        }
    }
