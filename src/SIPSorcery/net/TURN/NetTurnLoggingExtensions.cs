...
internal static partial class NetTurnLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "TurnServerExperimentalWarning",
        Level = LogLevel.Warning,
        Message = "TURN server is intended for development, testing and small scale or embedded scenarios and is not hardened for production use. It has no nonce validation, no rate limiting or per-IP allocation caps and no TLS/DTLS on the control channel. Use coturn or an equivalent for production deployments.")]
    public static partial void LogTurnServerExperimentalWarning(
        this ILogger logger);

    [LoggerMessage(
        EventId = 0,
        EventName = "TurnTcpChannelDataDropped",
        Level = LogLevel.Warning,
        Message = "TURN server dropped channel data from TCP client {Client} that could not be processed. {ErrorMessage}")]
    public static partial void LogTurnTcpChannelDataDropped(
        this ILogger logger,
        string client,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "TurnTcpStunUnparseable",
        Level = LogLevel.Warning,
        Message = "TURN server dropped an unparseable STUN message from TCP client {Client}. {ErrorMessage}")]
    public static partial void LogTurnTcpStunUnparseable(
        this ILogger logger,
        string client,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "TurnTcpStunProcessingFailed",
        Level = LogLevel.Warning,
        Message = "TURN server failed to process a STUN message from TCP client {Client}. {ErrorMessage}")]
    public static partial void LogTurnTcpStunProcessingFailed(
        this ILogger logger,
        string client,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "TurnUdpDatagramDropped",
        Level = LogLevel.Warning,
        Message = "TURN server dropped a UDP datagram from {Remote} that could not be processed. {ErrorMessage}")]
    public static partial void LogTurnUdpDatagramDropped(
        this ILogger logger,
        IPEndPoint remote,
        string errorMessage,
        Exception exception);
