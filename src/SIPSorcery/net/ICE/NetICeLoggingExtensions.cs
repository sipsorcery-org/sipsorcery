...
internal static partial class NetIceLoggingExtensions
{
    ...
    private static partial void LogIceChannelFailedUnchecked(
        this ILogger logger,
        double elapsedSeconds);

    public static void LogIceChannelFailed(
        this ILogger logger,
        DateTime checklistStartedAt)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
            logger.LogIceChannelFailedUnchecked(DateTime.Now.Subtract(checklistStartedAt).TotalSeconds);
        }
    }
    ...
    [LoggerMessage(
        ...
        SkipEnabledCheck = true)]
    private static partial void LogIceChecklistNominatedBindingUnchecked(
        this ILogger logger,
        string remoteCandidate);

    public static void LogIceChecklistNominatedBinding(
        this ILogger logger,
        RTCIceCandidate remoteCandidate)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
            logger.LogIceChecklistNominatedBindingUnchecked(remoteCandidate.ToShortString());
        }
    }
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceTurnResendCreatePermission",
        Level = LogLevel.Debug,
        Message = "ICE RTP channel re-sending TURN Create Permission after auth challenge {ErrorCode} from {RemoteEndPoint} for peer {Peer}.")]
    public static partial void LogIceTurnResendCreatePermission(
        this ILogger logger,
        int? errorCode,
        IPEndPoint? remoteEndPoint,
        IPEndPoint? peer);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceTurnCreatePermissionErrorDetailed",
        Level = LogLevel.Warning,
        Message = "ICE RTP channel TURN Create Permission error response {ErrorCode} {ReasonPhrase} was received from {RemoteEndPoint} for peer {Peer}.")]
    public static partial void LogIceTurnCreatePermissionError(
        this ILogger logger,
        int errorCode,
        string reasonPhrase,
        IPEndPoint remoteEndPoint,
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceTurnCreatePermissionError",
        Level = LogLevel.Warning,
        Message = "ICE RTP channel TURN Create Permission error response was received from {RemoteEndPoint} for peer {Peer}.")]
    public static partial void LogIceTurnCreatePermissionError(
        this ILogger logger,
        IPEndPoint remoteEndPoint,
        IPEndPoint? peer);
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Warning,
        Message = "RTPIceChannel Send over TCP error: {SocketErrorCode}")]
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "ReceivedStunResponse",
        Level = LogLevel.Debug,
        Message = "Received STUN response from remote endpoint {RemoteEndPoint}, local port {LocalPort}: {StunMessage}")]
    public static partial void LogReceivedStunResponse(
        this ILogger logger,
        IPEndPoint remoteEndPoint,
        int localPort,
        STUNMessage stunMessage);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "SendStunBindingRequest",
        Level = LogLevel.Debug,
        Message = "Sending STUN binding request to ICE server {Uri} with address {EndPoint}: {StunMessage}")]
    public static partial void LogSendStunBindingRequest(
        this ILogger logger,
        STUNUri uri,
        IPEndPoint endPoint,
        STUNMessage stunMessage);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "SendTurnAllocateRequest",
        Level = LogLevel.Debug,
        Message = "Sending TURN allocate request to ICE server {Uri} with address {EndPoint}: {StunMessage}")]
    public static partial void LogSendTurnAllocateRequest(
        this ILogger logger,
        STUNUri uri,
        IPEndPoint endPoint,
        STUNMessage stunMessage);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "SendTurnRefreshRequest",
        Level = LogLevel.Debug,
        Message = "Sending TURN refresh request to ICE server {Uri} with address {EndPoint}: {StunMessage}")]
    public static partial void LogSendTurnRefreshRequest(
        this ILogger logger,
        STUNUri uri,
        IPEndPoint endPoint,
        STUNMessage stunMessage);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "SendTurnCreatePermissionsRequest",
        Level = LogLevel.Debug,
        Message = "Sending TURN create permissions request to ICE server {Uri} with address {EndPoint}: {StunMessage}")]
    public static partial void LogSendTurnCreatePermissionsRequest(
        this ILogger logger,
        STUNUri uri,
        IPEndPoint endPoint,
        STUNMessage stunMessage);
    ...
    [LoggerMessage(
        ...
        SkipEnabledCheck = true)]
    private static partial void LogIceNominatedNewCandidateUnchecked(
        this ILogger logger,
        string remoteCandidate);

    public static void LogIceNominatedNewCandidate(
        this ILogger logger,
        RTCIceCandidate remoteCandidate)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
            logger.LogIceNominatedNewCandidateUnchecked(remoteCandidate.ToShortString());
        }
    }
    ...
    [LoggerMessage(
        ...
        SkipEnabledCheck = true)]
    private static partial void LogIceServerUrlParseErrorUnchecked(
        this ILogger logger,
        string url);

    public static void LogIceServerUrlParseError(
        this ILogger logger,
        ReadOnlySpan<char> url)
    {
        if (logger.IsEnabled(LogLevel.Warning))
        {
            logger.LogIceServerUrlParseErrorUnchecked(url.ToString());
        }
    }
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "MdnsResolutionNoAnswers",
        Level = LogLevel.Warning,
        Message = "RTP ICE channel mDNS resolver returned no answers for {CandidateAddress} within the timeout.")]
    public static partial void LogMdnsResolutionNoAnswers(
        this ILogger logger,
        string candidateAddress);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "StunUnauthorisedError",
        Level = LogLevel.Debug,
        Message = "Received STUN Unauthorized error from {RemoteEndPoint}.")]
    public static partial void LogStunUnauthorisedError(
        this ILogger logger,
        IPEndPoint remoteEndPoint);

    [LoggerMessage(
        EventId = 0,
        EventName = "StunStaleNonceError",
        Level = LogLevel.Error,
        Message = "Received STUN NONCE error from {RemoteEndPoint}.")]
    public static partial void LogStunStaleNonceError(
        this ILogger logger,
        IPEndPoint remoteEndPoint);

    [LoggerMessage(
        EventId = 0,
        EventName = "IceServerErrorResponseForAllocate",
        Level = LogLevel.Warning,
        Message = "ICE session received an error response for an Allocate request to {Uri} from {RemoteEP}.")]
    public static partial void LogIceServerErrorResponseForAllocate(
        this ILogger logger,
        STUNUri uri,
        IPEndPoint remoteEp);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceCandidatesUnavailable",
        Level = LogLevel.Debug,
        Message = "RTP ICE Channel has no MDNS resolver set, and the system can not resolve remote candidate with MDNS hostname {CandidateAddress}.")]
    public static partial void LogIceCandidatesUnavailable(
        this ILogger logger,
        string candidateAddress);

    [LoggerMessage(
        EventId = 0,
        EventName = "IceLocalCandidateCount",
        Level = LogLevel.Debug,
        Message = "RTP ICE Channel discovered {CandidateCount} local candidates.")]
    public static partial void LogIceLocalCandidateCount(
        this ILogger logger,
        int candidateCount);

    [LoggerMessage(
        EventId = 0,
        EventName = "IceRelayOnlyPolicy",
        Level = LogLevel.Debug,
        Message = "RTP ICE Channel is using a relay only policy, no local candidates will be gathered.")]
    public static partial void LogIceRelayOnlyPolicy(
        this ILogger logger);

    [LoggerMessage(
        EventId = 0,
        EventName = "IceTcpReceiveError",
        Level = LogLevel.Error,
        Message = "Exception IceTcpReceiver.EndReceiveFrom. {ErrorMessage}")]
    public static partial void LogIceTcpReceiveError(
        this ILogger logger,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceSocketEndReceiveWarning",
        Level = LogLevel.Warning,
        Message = "SocketException RtpIceChannel.EndReceiveFrom ({SocketErrorCode}). {ErrorMessage}")]
    public static partial void LogIceSocketEndReceiveWarning(
        this ILogger logger,
        SocketError socketErrorCode,
        string errorMessage,
        Exception exception);
    ...
    [LoggerMessage(
        EventId = 0,
        EventName = "IceMdnsStartFailed",
        Level = LogLevel.Warning,
        Message = "Failed to start mDNS MulticastService; .local hostname resolution will not work.")]
    public static partial void LogIceMdnsStartFailed(
        this ILogger logger,
        Exception exception);

    [LoggerMessage(
        EventId = 0,
        EventName = "IceChecklistEntriesFailed",
        Level = LogLevel.Debug,
        Message = "ICE RTP channel connect failed as all checklist entries are in a failed state.")]
    public static partial void LogIceChecklistEntriesFailed(
        this ILogger logger);
}
