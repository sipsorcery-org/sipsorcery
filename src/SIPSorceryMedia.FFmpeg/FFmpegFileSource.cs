...
#pragma warning restore CS0067
    ...
    {
        // The original behaviour was very wrong. The "Has" check should not be a mutating call and shuld simply return the current state.
        // The original code is being left commented out in case someone was relying on it. It is safe to remove once the library
        // has had 3 version releases which will be >= 10.0.13. AC 8 Jun 2026.
    ...
    public bool HasRawVideoSubscribers()
    {
        ...
        return OnVideoSourceRawSampleFaster != null;
