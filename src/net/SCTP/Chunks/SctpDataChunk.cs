...
public partial class SctpDataChunk : SctpChunk
{
        ...
        byte[] data) : base(SctpChunkType.DATA)
    {
        ...
        {
            throw new ArgumentException("The SctpDataChunk data parameter cannot be empty.", nameof(data));
        }
    ...
    public static SctpDataChunk ParseChunk(ReadOnlySpan<byte> buffer)
    {
        ...
        {
            throw new SipSorceryException($"SCTP data chunk cannot be parsed as buffer too short for fixed parameter fields.");
        }
