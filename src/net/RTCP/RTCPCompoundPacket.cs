...
namespace SIPSorcery.Net
{
    ...
    /// </summary>
    public partial class RTCPCompoundPacket
    {
        ...
        public int GetPacketSize()
        {
            ...
            return (SenderReport?.GetPacketSize()).GetValueOrDefault() +
