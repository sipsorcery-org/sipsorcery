...
internal sealed class RTCDataChannelCollection : IReadOnlyCollection<RTCDataChannel>
{
    ...
    public IEnumerator<RTCDataChannel> GetEnumerator()
        => pendingChannels.Concat(activeChannels.Select(static e => e.Value)).GetEnumerator();
