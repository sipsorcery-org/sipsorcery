...
namespace Vpx.Net
{
    public unsafe static class reconinter
    {
        const int CHAR_BIT = 8;

        public static void vp8_copy_mem16x16_c(byte* src, int src_stride, byte* dst,
                         int dst_stride)
        {
            int r;
        ...
        public static void vp8_copy_mem8x8_c(byte* src, int src_stride, byte* dst,
                               int dst_stride)
        {
            int r;
        ...
        public static void vp8_copy_mem8x4_c(byte* src, int src_stride, byte* dst,
                               int dst_stride)
        {
            int r;
                                             ...
                                             byte* base_pre, int pre_stride)
        {
            ...
            {
                vp8_rtcd.vp8_copy_mem8x8(ptr, pre_stride, dst, dst_stride);
            }
        }
