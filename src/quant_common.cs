...
namespace Vpx.Net
{
    public static class quant_common
    {
        public static readonly int[] dc_qlookup = {
        ...
        public static readonly int[] ac_qlookup = {
        ...
        public static int vp8_dc_quant(int QIndex, int Delta)
        {
            int retval;
        ...
        public static int vp8_dc2quant(int QIndex, int Delta)
        {
            int retval;
        ...
        public static int vp8_dc_uv_quant(int QIndex, int Delta)
        {
            int retval;
        ...
        public static int vp8_ac_yquant(int QIndex)
        {
            int retval;
        ...
        public static int vp8_ac2quant(int QIndex, int Delta)
        {
            int retval;
        ...
        public static int vp8_ac_uv_quant(int QIndex, int Delta)
        {
            int retval;
