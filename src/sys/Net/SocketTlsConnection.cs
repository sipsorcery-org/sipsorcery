...
{
    internal class SocketTlsConnection : SocketTcpConnection
    {
        ...
        {
            m_sslClientAuthenticationOptions = SslStreamExtensions.Clone(sslClientAuthenticationOptions);
        ...
        protected override async Task SendToCoreAsync(IPEndPoint dstEndPoint, ReadOnlyMemory<byte> buffer, IDisposable? memoryOwner)
        {
            ...
            try
            {
                ...
                Debug.Assert(m_sslStream is not null);
