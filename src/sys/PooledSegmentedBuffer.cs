...
internal sealed class PooledSegmentedBuffer<T> : IBufferWriter<T>, IDisposable
{
    ...
    public void Advance(int count)
    {
        ...
        ArgumentOutOfRangeExceptionExtensions.ThrowIfNegative(count);
    ...
    {
        ObjectDisposedExceptionExtensions.ThrowIf(_disposed, nameof(PooledSegmentedBuffer<T>));
    ...
    private sealed class PooledSegmentedBufferStream : Stream
    {
        ...
        {
            ObjectDisposedExceptionExtensions.ThrowIf(_disposed, nameof(PooledSegmentedBufferStream));
            ObjectDisposedExceptionExtensions.ThrowIf(_buffer._disposed, nameof(PooledSegmentedBuffer<T>));

            ArgumentNullExceptionExtensions.ThrowIfNull(buffer);

            ArgumentOutOfRangeExceptionExtensions.ThrowIfNegative(offset);
            ArgumentOutOfRangeExceptionExtensions.ThrowIfGreaterThan(offset, buffer.Length);
            ArgumentOutOfRangeExceptionExtensions.ThrowIfNegative(count);
            ArgumentOutOfRangeExceptionExtensions.ThrowIfGreaterThan(count, buffer.Length - offset);
