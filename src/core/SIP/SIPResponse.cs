...
namespace SIPSorcery.SIP
{
    ...
    public class SIPResponse
	{
        ...
        /// <summary>
        /// For responses generated by us the remote SIP socket the response should be sent to.
        ...
        /// <summary>
        /// For responses generated by us the local SIP socket the response should be sent from.
