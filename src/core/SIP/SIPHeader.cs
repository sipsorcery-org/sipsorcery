...
namespace SIPSorcery.SIP
{
                ...
                foreach (string viaHeaderStrItem in viaHeaders)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (delimIndex == -1)
                            {
                                //logger.LogMissingSemiColon(header);
                            ...
                            if (contactAddress == null || contactAddress.Trim().Length == 0)
                            {
                                ...
                                //{
                                //    logger.LogInvalidViaHeader(header);
                                //    parserError = SIPValidationError.NoBranchOnVia;
                                //    return null;
                                //}
    ...
    public class SIPHeader
    {
        ...
        public static SIPHeader ParseSIPHeaders(string[] headersCollection)
        {
            try
            {
                ...
                for (int lineIndex = 0; lineIndex < headersCollection.Length; lineIndex++)
                {
                    ...
                    try
                    {
                        ...
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_CSEQ.ToLower())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    logger.LogInvalidCSeqInteger(headerLine);
                                }
                                ...
                                {
                                    logger.LogMissingCSeqMethod(headerLine);
                                }
                            }
                        }
                        #endregion
                        ...
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_EXPIRES.ToLower())
                        {
                            ...
                            {
                                logger.LogInvalidExpiresInteger(headerLine);
                            }
                        }
                        #endregion
                        #region Min-Expires
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_MINEXPIRES.ToLower())
                        {
                            ...
                            {
                                logger.LogInvalidMinExpiresInteger(headerLine);
                            }
                        }
                        #endregion
                        #region Contact
                        ...
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_MAXFORWARDS.ToLower())
                        {
                            ...
                            {
                                logger.LogInvalidMaxForwardsInteger(headerLine);
                            }
                        }
                        #endregion
                            ...
                            headerNameLower == SIPHeaders.SIP_HEADER_CONTENTLENGTH.ToLower())
                        {
                            ...
                            {
                                logger.LogInvalidContentLengthInteger();
                            }
                        }
                        #endregion
                        #region ContentType
                        ...
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_RELIABLE_ACK.ToLower())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    logger.LogInvalidRSeqInteger(headerLine);
                                }
                                ...
                                if (rackFields?.Length > 1)
                                {
                                    ...
                                    {
                                        logger.LogInvalidCSeq(headerLine);
                                    }
                                }
                                else
                                {
                                    logger.LogEmptyRackMethod(headerLine);
                                }
                        ...
                        else if (headerNameLower == SIPHeaders.SIP_HEADER_RELIABLE_SEQ.ToLower())
                        {
                            ...
                            {
                                logger.LogInvalidRSeqValue(headerLine);
                            }
                        }
                        #endregion
                        #region Server
                    ...
                    {
                        logger.LogHeaderParseError(headerLine, parseExcp.Message, parseExcp);
                ...
                if (sipHeader.HistoryInfo != null && sipHeader.HistoryInfo.Count > 1)
                {
                    ...
                    {
                        logger.LogHistoryInfoSortError();
                    }
                }
            ...
            {
                logger.LogParseSIPHeadersError(excp.Message, excp);
        ...
        public new string ToString()
        {
            ...
            {
                logger.LogSIPHeaderToString(excp.Message, excp);
                throw;
            }
        }
        ...
        public string GetUnknownHeaderValue(string unknownHeaderName)
        {
            ...
            else
            {
                foreach (string unknonwHeader in UnknownHeaders)
                {
                    ...
                    if (delimiterIndex == -1)
                    {
                        logger.LogInvalidUnknownHeader(unknonwHeader);
                        continue;
                    }
